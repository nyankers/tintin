...
struct help_type help_table[] =
{
	...
	},
	{
		"CALL",
		TOKEN_TYPE_COMMAND,
		"<178>Command<278>: #call <178>{<278>name<178>} {<278>argument1<178>} {<278>argument2<178>} {<278>etc<178>}\n"
		"\n"
		"<278>         Call a procedure by name.\n"
		"\n"
		"<178>Example<278>: #proc sysmsg {#echo {<<888>faa>(System Message) <<888>acf>%s<<888>088>} {%1}}\n"
		"<278>         #call sysmsg {Hello world.}\n"
		,
		"lua procedure"
	},
	{
	...
	},
	{
		...
		TOKEN_TYPE_STRING,
		"\n"
		"<278>         The <178>tt<278> lua module contains various functions to retrieve\n"
		"<278>         tintin++ data.\n"
		"\n"
		"<278>         Each optionally takes a <178>match<278> argument, which works much as\n"
		"<278>         the equivalent tintin++ commands, allowing exact names to be given as\n"
		"<278>         well as wildcards.\n"
		"\n"
		"<278>         Entries with classes additionally have a <178>class<278> field, and entries with\n"
		"<278>         a limited number of shots have this number in a <178>shots<278> field.\n"
		"\n"
		"<278>         <178>tt.actions<278>([<178>match<278>])             Retrieves #ACTIONS.\n"
		"<278>          Fields: match, cmd, priority.\n"
		"\n"
		"<278>         <178>tt.aliases<278>([<178>match<278>])             Retrieves #ALIASES.\n"
		"<278>          Fields: match, cmd, priority.\n"
		"\n"
		"<278>         <178>tt.buttons<278>([<178>match<278>])             Retrieves #BUTTONS.\n"
		"<278>          Fields: name, row1, row2, col1, col2, priority, cmd.\n"
		"\n"
		"<278>         <178>tt.classes<278>([<178>match<278>])             Retrieves #CLASSES.\n"
		"<278>          Fields: name, open, memory.\n"
		"\n"
		"<278>         <178>tt.commands<278>([<178>match<278>])            Retrieves #COMMANDS.\n"
		"<278>          Fields: name.\n"
		"\n"
		"<278>         <178>tt.configs<278>([<178>match<278>])             Retrieves #CONFIGS.\n"
		"<278>          Fields: name, value.\n"
		"\n"
		"<278>         <178>tt.delays<278>([<178>match<278>])              Retrieves #DELAYS.\n"
		"<278>          Fields: name, cmd, time.\n"
		"\n"
		"<278>         <178>tt.events<278>([<178>match<278>])              Retrieves #EVENTS.\n"
		"<278>          Fields: event, cmd.\n"
		"\n"
		"<278>         <178>tt.functions<278>([<178>match<278>])           Retrieves #FUNCTIONS.\n"
		"<278>          Fields: name, priority, cmd.\n"
		"\n"
		"<278>         <178>tt.gags<278>([<178>match<278>])                Retrieves #GAGS.\n"
		"<278>          Fields: match.\n"
		"\n"
		"<278>         <178>tt.highlights<278>([<178>match<278>])          Retrieves #HIGHLIGHTS.\n"
		"<278>          Fields: match, color, priority.\n"
		"\n"
		"<278>         <178>tt.histories<278>([<178>match<278>])           Retrieves #HISTORIES.\n"
		"<278>          Fields: line.\n"
		"\n"
		"<278>         <178>tt.landmarks<278>([<178>match<278>])           Retrieves #LANDMARKS.\n"
		"<278>          Fields: name, desc, size, vnum.\n"
		"\n"
		"<278>         <178>tt.macros<278>([<178>match<278>])              Retrieves #MACROS.\n"
		"<278>          Fields: input, cmd, compiled.\n"
		"\n"
		"<278>         <178>tt.paths<278>([<178>match<278>])               Retrieves #PATHS.\n"
		"<278>          Fields: forward, backward, delay.\n"
		"\n"
		"<278>         <178>tt.pathdirs<278>([<178>match<278>])            Retrieves #PATHDIRS.\n"
		"<278>          Fields: dir, reverse, coord.\n"
		"\n"
		"<278>         <178>tt.procedures<278>([<178>match<278>])          Retrieves #PROCEDURES.\n"
		"<278>          Fields: name, cmd.\n"
		"\n"
		"<278>         <178>tt.prompts<278>([<178>match<278>])             Retrieves #PROMPTS.\n"
		"<278>          Fields: match, sub, row, col.\n"
		"\n"
		"<278>         <178>tt.substitutes<278>([<178>match<278>])         Retrieves #SUBSTITUTES.\n"
		"<278>          Fields: match, sub, priority.\n"
		"\n"
		"<278>         <178>tt.tabs<278>([<178>match<278>])                Retrieves #TABS.\n"
		"<278>          Fields: tab.\n"
		"\n"
		"<278>         <178>tt.terrains<278>([<178>match<278>])            Retrieves #TERRAINS.\n"
		"<278>          Fields: name, symbol, flags.\n"
		"\n"
		"<278>         <178>tt.tickers<278>([<178>match<278>])             Retrieves #TICKERS.\n"
		"<278>          Fields: name, cmd, delay, time.\n"
		"\n"
		"<278>         <178>tt.variables<278>([<178>match<278>])           Retrieves #VARIABLES.\n"
		"<278>          Fields: name, value.\n"
		"\n"
		"<278>         Each of the above functions will return an array with the respective\n"
		"<278>         data, even if an exact name is given or only one match is found.\n"
		,
		"lua map_api regexp tt_api"
	},
	{
		"GREETING",
		TOKEN_TYPE_STRING,
...
//		"<268>      #<278>                                                                  <268>#\n"
	...
	},
	{
		...
		"<178>Command<278>: #lua\n"
		"\n"
		"<278>         The lua command is used to run lua scripts.\n"
		"\n"
		"<278>         <178>#lua check [variable]\n"
		"<278>          Checks if lua is enabled.\n"
		"\n"
		"<278>          If a variable name is provided, it will store 1 if lua is\n"
		"<278>          enabled, or 0 otherwise.\n"
		"\n"
		"<278>         <178>#lua exec <script>\n"
		"<278>          Runs the given lua script verbatim.\n"
		"\n"
		"<278>          Variable and functions are not substituted by default.\n"
		"\n"
		"<278>         <178>#lua read <file>\n"
		"<278>          Loads the given file as a lua script.\n"
		"\n"
		"<278>         <178>#lua restart\n"
		"<278>          Restarts the lua context for the current session.\n"
		"\n"
		"<278>          This does not remove any triggers created in lua. It only\n"
		"<278>          exists as a convenience to refresh the session's global\n"
		"<278>          environment.\n"
		,
		"lua_getters map_api tt_api"
	},
	{
		"MACRO",
		TOKEN_TYPE_CONFIG,
...

	{
		...
		TOKEN_TYPE_STRING,
		"\n"
		"<278>         The <178>map<278> module is provided to access map data.\n"
		"\n"
		"<278>         There is current no support for updating the map directly via lua.\n"
		"<278>         Instead, you can use the <178>tt.exec()<278> function as needed.\n"
		"\n"
		"<278>         The module has the following general-purpose commands:\n"
		"\n"
		"<278>         <178>map.at<278>(<178>vnum<278>, <178>cmd<278>)\n"
		"<278>           Functions similar to #map at.\n"
		"\n"
		"<278>         <178>map.check_room<278>(<178>vnum<278>)\n"
		"<278>           Returns true if the room exists.\n"
		"\n"
		"<278>         <178>map.check_exit<278>(<178>exit<278>, [<178>vnum<278>])\n"
		"<278>           Returns true if the exit exists.\n"
		"\n"
		"<278>         <178>map.count<278>()\n"
		"<278>           Returns the number of rooms and exits in the current map.\n"
		"\n"
		"<278>         <178>map.exists<278>()\n"
		"<278>           Returns true if there is currently a map, otherwise false.\n"
		"\n"
		"<278>         <178>map.find<278>(<178>search<278>, [<178>vum<278>])\n"
		"<278>           Returns a table of information about the closest room that matches the\n"
		"<278>           given <178>search<278>, with the following fields: <178>vnum<278>, <178>distance<278>, <178>x<278>, <178>y<278>, <178>z<278>.\n"
		"<278>           Returns nil if there was no match.\n"
		"\n"
		"<278>         <178>map.get_worldflags<278>()\n"
		"<278>           Retrieves the map world flags as an integer.\n"
		"\n"
		"<278>         <178>map.get_dir<278>()\n"
		"<278>           Retrieves the current map direction.\n"
		"\n"
		"<278>         <178>map.get_pathdir<278>()\n"
		"<278>           Retrieves the current map pathdir.\n"
		"\n"
		"<278>         <178>map.global<278>()\n"
		"<278>           Returns the current vnum of the room containing global exits, as set\n"
		"<278>           via #map global.\n"
		"\n"
		"<278>         <178>map.inside<278>()\n"
		"<278>           Returns true if you're currently in the map, otherwise false.\n"
		"\n"
		"<278>         <178>map.last_room<278>()\n"
		"<278>           Returns the last room you were in before this one.\n"
		"\n"
		"<278>         <178>map.list<278>(<178>search<278>, [<178>vum<278>])\n"
		"<278>           Returns a map of all rooms that match the given search, with the rooms'\n"
		"<278>           vnums as their keys and the values being tables in the same format as\n"
		"<278>           returned by map.find() above.\n"
		"\n"
		"<278>           Note: Unconnected rooms have no distance field.\n"
		"\n"
		"<278>         <178>map.size<278>()\n"
		"<278>           Returns the size allotted for the map.\n"
		"\n"
		"<278>         The search criteria for map.find() and map.list() can either be a\n"
		"<278>         string (in which case it searches by room ID), a table array of two\n"
		"<278>         numbers (in which case it matches a range of vnums), or a table with\n"
		"<278>         the following optional fields:\n"
		"\n"
		"<278>           <178>name<278>            Matches on the roomname field\n"
		"<278>           <178>desc<278>            Matches on the roomdesc field\n"
		"<278>           <178>area<278>            Matches on the roomarea field\n"
		"<278>           <178>note<278>            Matches on the roomnote field\n"
		"<278>           <178>terrain<278>         Matches on the roomterrain field\n"
		"<278>           <178>flags<278>           Matches on the roomflags field\n"
		"<278>           <178>id<278>              Matches on the roomid field\n"
		"<278>           <178>distance<278>        Matches on the roomdistance field\n"
		"\n"
		"<278>         Besides flags and distance, which must be numbers, the rest may contain\n"
		"<278>         tintin++ regex.\n"
		"\n"
		"<278>         The module also has an assortment of room and exit data getters:\n"
		"\n"
		"<278>           <178>map.get_all<278>([<178>vnum<278>])             Gets all room data as a table\n"
		"<278>           <178>map.get_area<278>([<178>vnum<278>])\n"
		"<278>           <178>map.get_color<278>([<178>vnum<278>])\n"
		"<278>           <178>map.get_data<278>([<178>vnum<278>])\n"
		"<278>           <178>map.get_desc<278>([<178>vnum<278>])\n"
		"<278>           <178>map.get_flags<278>([<178>vnum<278>])           Gets room flags as an integer\n"
		"<278>           <178>map.get_id<278>([<178>vnum<278>])\n"
		"<278>           <178>map.get_name<278>([<178>vnum<278>])\n"
		"<278>           <178>map.get_note<278>([<178>vnum<278>])\n"
		"<278>           <178>map.get_symbol<278>([<178>vnum<278>])\n"
		"<278>           <178>map.get_terrain<278>([<178>vnum<278>])\n"
		"<278>           <178>map.get_vnum<278>([<178>vnum<278>])\n"
		"<278>           <178>map.get_weight<278>([<178>vnum<278>])\n"
		"<278>           <178>map.get_exits<278>([<178>vnum<278>])           Gets all room exits as a table\n"
		"\n"
		"<278>           <178>map.exit<278>(<178>exit<278>, [<178>vnum<278>])          Gets all data for an exit as a table\n"
		"<278>           <178>map.exit_color<278>(<178>exit<278>, [<178>vnum<278>])\n"
		"<278>           <178>map.exit_cmd<278>(<178>exit<278>, [<178>vnum<278>])\n"
		"<278>           <178>map.exit_data<278>(<178>exit<278>, [<178>vnum<278>])\n"
		"<278>           <178>map.exit_delay<278>(<178>exit<278>, [<178>vnum<278>])\n"
		"<278>           <178>map.exit_dir<278>(<178>exit<278>, [<178>vnum<278>])\n"
		"<278>           <178>map.exit_flags<278>(<178>exit<278>, [<178>vnum<278>])    Gets exit flags as an integer\n"
		"<278>           <178>map.exit_name<278>(<178>exit<278>, [<178>vnum<278>])\n"
		"<278>           <178>map.exit_vnum<278>(<178>exit<278>, [<178>vnum<278>])\n"
		"<278>           <178>map.exit_weight<278>(<178>exit<278>, [<178>vnum<278>])\n"
		"\n"
		"<278>         The module also contains a large variety of flag constants:\n"
		"\n"
		"<278>         <128>Room flags:\n"
		"\n"
		"<278>         ROOM_FLAG_AVOID, ROOM_FLAG_HIDE, ROOM_FLAG_LEAVE, ROOM_FLAG_VOID,\n"
		"<278>         ROOM_FLAG_STATIC, ROOM_FLAG_CURVED, ROOM_FLAG_PATH, ROOM_FLAG_NOGLOBAL,\n"
		"<278>         ROOM_FLAG_INVIS, ROOM_FLAG_BLOCK, ROOM_FLAG_TERRAIN, and ROOM_FLAG_FOG\n"
		"\n"
		"<278>         <128>Exit flags:\n"
		"\n"
		"<278>         EXIT_FLAG_HIDE, EXIT_FLAG_AVOID, EXIT_FLAG_INVIS, and EXIT_FLAG_BLOCK\n"
		"\n"
		"<278>         <128>Map flags:\n"
		"\n"
		"<278>         MAP_FLAG_ASCIIGRAPHICS, MAP_FLAG_ASCIILENGTH, MAP_FLAG_ASCIIVNUMS,\n"
		"<278>         MAP_FLAG_AUTOLINK, MAP_FLAG_BLOCKGRAPHICS, MAP_FLAG_DIRECTION,\n"
		"<278>         MAP_FLAG_MUDFONT, MAP_FLAG_NOFOLLOW, MAP_FLAG_QUIET, MAP_FLAG_STATIC,\n"
		"<278>         MAP_FLAG_SYMBOLGRAPHICS, MAP_FLAG_TERRAIN, and MAP_FLAG_UNICODEGRAPHICS\n"
		"\n"
		"<278>         <128>Terrain flags:\n"
		"\n"
		"<278>         TERRAIN_FLAG_DENSE, TERRAIN_FLAG_AMPLE, TERRAIN_FLAG_SPARSE,\n"
		"<278>         TERRAIN_FLAG_SCANT, TERRAIN_FLAG_NARROW, TERRAIN_FLAG_STANDARD,\n"
		"<278>         TERRAIN_FLAG_WIDE, TERRAIN_FLAG_VAST, TERRAIN_FLAG_FADEIN,\n"
		"<278>         TERRAIN_FLAG_FADEOUT, and TERRAIN_FLAG_DOUBLE\n"
		,
		"lua lua_getters tt_api"
	},
...
//		"<268>         │<178>   yocto <268>│<178>      y <268>│<178>0.000 000 000 000 000 000 000 001<268>│\n"
...

	{
		"PROCEDURE",
		TOKEN_TYPE_COMMAND,
		"<178>Command<278>: #procedure <178>{<278>name<178>} {<278>operation<178>}\n"
		"\n"
		"<278>         Procedures allow you to store a script for future execution.\n"
		"\n"
		"<178>Example<278>: #proc sysmsg {#echo {<<888>faa>(System Message) <<888>acf>%s<<888>088>} {%1}}\n"
		"<278>         #call sysmsg {Hello world.}\n"
		"\n"
		"<178>Comment<278>: You can remove a procedure with the #unprocedure command.\n"
		,
		"call lua"
	},
...

	{
		...
		TOKEN_TYPE_STRING,
		"\n"
		"<278>         The following lua functions are available in the preloaded <178>tt<278> module.\n"
		"\n"
		"<278>         Functions that accept a <178>cmd<278> parameter can accept a string containing a\n"
		"<278>         tintin++ script (e.g. '#echo {it works!}'), or a Lua function.\n"
		"\n"
		"<278>         Functions that accept a <178>sub<278> parameter can accept a string similar to\n"
		"<278>         the respective tintin++ commands, or a Lua function which is expected\n"
		"<278>         to return the string to be displayed. In the latter case, the function\n"
		"<278>         is responsible for any desired substitution.\n"
		"\n"
		"<278>         In both these cases, the Lua function will receive any usual parameters\n"
		"<278>         passed in the same order that an equivalent tintin script would, with\n"
		"<278>         the first argument containing %0, the second containing %1, and so on.\n"
		"\n"
		"<278>         Note: Lua functions cannot be saved via #WRITE or the #CLASS equivalent.\n"
		"\n"
		"<278>         The <178>convert_numbers<278> parameter may be given as false to\n"
		"<278>         prevent strings from being converted into numbers. The default behavior\n"
		"<278>         is to convert them.\n"
		"\n"
		"<278>         The <178>shots<278> parameter may be given to control how many shots a\n"
		"<278>         given trigger has before deleting itself. If 0 or nil is given, or the\n"
		"<278>         argument is withheld, then it may run until later removed.\n"
		"\n"
		"<278>         Arguments in square brackets are optional and are filled from left to\n"
		"<278>         right. You can safely pass in nil for the default behavior for any\n"
		"<278>         optional parameters.\n"
		"\n"
		"<278>         <178>tt.action<278>(<178>match<278>, [<178>priority<278>, <178>shots<278>,] <178>cmd<278>)\n"
		"<278>           Sets an #ACTION.\n"
		"\n"
		"<278>         <178>tt.alias<278>(<178>match<278>, [<178>priority<278>, <178>shots<278>,] <178>cmd<278>)\n"
		"<278>           Sets an #ALIAS.\n"
		"\n"
		"<278>         <178>tt.background<278>(<178>cmd<278>)\n"
		"<278>           Runs the given <178>cmd<278> in the background, as per #line\n"
		"<278>           background.\n"
		"\n"
		"<278>         <178>tt.button<278>(<178>row1<278>, <178>col1<278>, <178>row2<278>, <178>col2<278>, [<178>priority<278>, <178>event<278>, <178>shots<278>], <178>cmd<278>)\n"
		"<278>           Sets a #BUTTON with the given coordinates as numbers.\n"
		"\n"
		"<278>         <178>tt.button<278>(<178>coords<278>, [<178>priority<278>, <178>event<278>, <178>shots<278>], <178>cmd<278>)\n"
		"<278>           Sets a #BUTTON with the given coordinates as a string, useful for\n"
		"<278>           updating already existing buttons with particular names.\n"
		"\n"
		"<278>         <178>tt.class<278>(<178>class<278>, [<178>type<278>, <178>convert_numbers<278>])\n"
		"<278>           Retrieves all elements of an optionally given type.\n"
		"\n"
		"<278>         <178>tt.color<278>(<178>str<278>)\n"
		"<278>           Returns the given string with tintin++ colors applied.\n"
		"\n"
		"<278>         <178>tt.convert<278>(<178>cmd<278>)\n"
		"<278>           Runs the given <178>cmd<278> with escaped meta characters, as per\n"
		"<278>           #line convert.\n"
		"\n"
		"<278>         <178>tt.debug<278>(<178>cmd<278>)\n"
		"<278>           Runs the given <178>cmd<278> with debug enabled, as per #line debug.\n"
		"\n"
		"<278>         <178>tt.delay<278>(<178>delay<278>, <178>cmd<278>)\n"
		"<278>           Adds a #DELAY. Note that this can not be used to add a single-shot\n"
		"<278>           named ticker per convenience as #DELAY does.\n"
		"\n"
		"<278>         <178>tt.echo<278>(<178>str<278>, [<178>row<278>, <178>col<278>])\n"
		"<278>           Echos the given text as per #echo.\n"
		"\n"
		"<278>         <178>tt.event<278>(<178>event<278>, [<178>shots<278>], <178>cmd<278>)\n"
		"<278>           Sets an #EVENT.\n"
		"\n"
		"<278>         <178>tt.exec<278>(<178>str<278>, <178>args<278>...)\n"
		"<278>           Inputs the given string, executing it as if it were a tintin++\n"
		"<278>           script. Multiple <178>args<278> may optionally be given for\n"
		"<278>           convenience, in which case they are wrapped in braces and secured\n"
		"<278>           (per #line substitute secure.)\n"
		"\n"
		"<278>           An array of strings given as one of the <178>args<278> will be\n"
		"<278>           expanded appropriately, e.g. exec('#echo', {'%s', -1}, '{Text.}') will\n"
		"<278>           be executed as #echo {{%s}{-1}} {\x7BText.\x7D}.\n"
		"\n"
		"<278>           Warning: The initial <178>str<278> is intentionally not secured.\n"
		"\n"
		"<278>         <178>tt.fun<278>(<178>name<278>, [<178>shots<278>], <178>cmd<278>)\n"
		"<278>           Sets a #FUNCTION.\n"
		"\n"
		"<278>         <178>tt.get<278>(<178>variable<278>..., [<178>convert_numbers<278>])\n"
		"<278>           Retrieves a tintin++ variable.\n"
		"\n"
		"<278>           If a single argument is passed, it may be a string following the\n"
		"<278>           format used by #var (e.g. 'var[a][b]'), or a table in which the first\n"
		"<278>           element is used as the base variable name, and each element\n"
		"<278>           thereafter is an index (e.g. {'var', 'a', 'b'}).\n"
		"\n"
		"<278>           Multiple arguments may be passed for convenience, in which case they\n"
		"<278>           behave in a manner similar to the table operation above (e.g.\n"
		"<278>           tt.get('var', 'a', 'b').)\n"
		"\n"
		"<278>         <178>tt.get_input<278>()\n"
		"<278>           Returns the current input line as per #cursor get.\n"
		"\n"
		"<278>         <178>tt.get_gag<278>()\n"
		"<278>           Returns the current gag level.\n"
		"\n"
		"<278>         <178>tt.history<278>(<178>n<278>)\n"
		"<278>           Returns the nth line from history. If this is a negative number, it\n"
		"<278>           looks backwards, e.g. history(-1) retrieves the last line entered.\n"
		"\n"
		"<278>         <178>tt.history<278>([<178>min<278>, <178>max<278>])\n"
		"<278>           If neither minimum nor maximum are given, this returns the whole\n"
		"<278>           history as an array of strings.\n"
		"\n"
		"<278>           If both are given, it returns all the lines between the given ones,\n"
		"<278>           where negative numbers look backwards as per above.\n"
		"\n"
		"<278>         <178>tt.history<278>('size')\n"
		"<278>           Returns the number of lines in history.\n"
		"\n"
		"<278>         <178>tt.ignore<278>(<178>cmd<278>)\n"
		"<278>           Executes the <178>cmd<278> without checking any triggers, as per\n"
		"<278>           #line ignore.\n"
		"\n"
		"<278>         <178>tt.macro<278>(<178>input<278>, [<178>shots<278>], <178>cmd<278>)\n"
		"<278>           Sets a #MACRO.\n"
		"\n"
		"<278>         <178>tt.parse<278>(<178>str<278>, [<178>convert_numbers<278>])\n"
		"<278>           Parses a tintin++ value into a lua string, number, or table.\n"
		"\n"
		"<278>           For example, tt.parse('{1}{a}{2}{{a}{b}}') returns {'a', {b = 'c'}}.\n"
		"\n"
		"<278>           This can be useful for handling events that receive information in\n"
		"<278>           this format.\n"
		"\n"
		"<278>         <178>tt.parse_list<278>(<178>str<278>, [<178>convert_numbers<278>])\n"
		"<278>           Parses a tintin++ simple list into a lua table.\n"
		"\n"
		"<278>           For example, tt.parse_list('{a}{b}{c}') returns {'a', 'b', 'c'}.\n"
		"\n"
		"<278>         <178>tt.print<278>(<178>str<278>, [<178>row<278>, <178>col<278>])\n"
		"<278>           Echos the given text as per #echo without processing tintin++ colors.\n"
		"\n"
		"<278>         <178>tt.proc<278>(<178>name<278>, [<178>shots<278>], <178>cmd<278>)\n"
		"<278>           Sets a #PROCEDURE.\n"
		"\n"
		"<278>         <178>tt.prompt<278>(<178>match<278>, [<178>row<278>, <178>col<278>, <178>shots<278>], <178>sub<278>)\n"
		"<278>           Sets a #PROMPT.\n"
		"\n"
		"<278>         <178>tt.quiet<278>(<178>cmd<278>)\n"
		"<278>           Executes the <178>cmd<278> suppressing most system messages, as per\n"
		"<278>           #line quiet.\n"
		"\n"
		"<278>         <178>tt.read_all<278>([<178>convert_numbers<278>])\n"
		"<278>           Reads all the tintin++ data into one table.\n"
		"\n"
		"<278>         <178>tt.session<278>(<178>session<278>, <178>fn<278>)\n"
		"<278>           Executes the given lua function within the given session.\n"
		"\n"
		"<278>           The function will have the current session's global environment\n"
		"<278>           despite running in the other session.\n"
		"\n"
		"<278>         <178>tt.session_env<278>(<178>session<278>)\n"
		"<278>           Retrieves a given session's lua global environment.\n"
		"\n"
		"<278>         <178>tt.set<278>(<178>variable<278>..., <178>value<278>)\n"
		"<278>           Sets a given variable to the given value.\n"
		"\n"
		"<278>           The <178>variable<278> argument(s) work as with tt.get().\n"
		"\n"
		"<278>           The value must be a string, number, or a simple table comprising only\n"
		"<278>           string/number keys and strings, numbers, or simple tables as values.\n"
		"\n"
		"<278>         <178>tt.show<278>(<178>str<278>, [<178>row<278>, <178>col<278>])\n"
		"<278>           Shows the given text as per #show, executing any triggers unless run\n"
		"<278>           an ignore.\n"
		"\n"
		"<278>         <178>tt.sub<278>(<178>match<278>, [<178>priority<278>, <178>shots<278>], <178>msg<278>)\n"
		"<278>           Sets a #SUBSTITUTE.\n"
		"\n"
		"<278>         <178>tt.substitute<278>(<178>str<278>, <178>flags<278>)\n"
		"<278>           Substitutes the given string with the given flags.\n"
		"\n"
		"<278>           Flags are the same binary values used internally within tintin++ and\n"
		"<278>           may be bitwise or'd or added together as needed. They're made\n"
		"<278>           available as constants on the tt module with the same names (in upper\n"
		"<278>           case) used for #line substitute:\n"
		"\n"
		"<278>           <178>tt.ARGUMENTS<278>, <178>tt.BRACES<278>, <178>tt.COLORS<278>, <178>tt.COMMANDS<278>, <178>tt.EOL<278>, <178>tt.ESCAPES<278>,\n"
		"<278>           <178>tt.FUNCTIONS<278>, <178>tt.LITERAL<278>, <178>tt.LNF<278>, <178>tt.SECURE<278>, and <178>tt.VARIABLES<278>\n"
		"<278>           \n"
		"\n"
		"<278>         <178>tt.tick<278>(<178>name<278>, <178>delay<278>, [<178>shots<278>], <178>cmd<278>)\n"
		"<278>           Sets a given #TICKER. A one-shot named delay can be done with this as\n"
		"<278>           well: tt.tick(name, delay, 1, cmd)\n"
		"\n"
		"<278>         <178>tt.var<278>(<178>variable<278>, [<178>value<278>])\n"
		"<278>           Retrieves or sets a variable using the tintin++ format instead of\n"
		"<278>           converting to or from tables.\n"
		"\n"
		"<278>           If <178>value<278> is false, then it deletes the variable instead.\n"
		,
		"lua_getters lua map_api"
	},
	...
	},
	{
		"WRITE",
		TOKEN_TYPE_COMMAND,
		"<178>Command<278>: #write <178>{<278><filename><178>} {<278>[FORCE]<178>} {<278>[LUA]<178>}\n"
		"\n"
		...
		"<278>         protection.\n"
		"\n"
		"<278>         Unless the LUA argument is provided, lua triggers will be ignored\n"
		"<278>         since they cannot be written. When this argument is provided, each\n"
		"<278>         lua trigger will generate a warning, as well as a #nop line in the\n"
		"<278>         resulting file, for diagnostic purposes.\n"
		,
